...
INSERT INTO items (item_id, category_id, item_name, color_id, manufacturer, price, stock, recommended) VALUES (nextval('items_item_id_seq'),1,'やばすぎるキャップ',5,'業務用帽子屋',3000,10,true);
...
INSERT INTO items (item_id, category_id, item_name, color_id, manufacturer, price, stock, recommended) VALUES (nextval('items_item_id_seq'),1,'小さいリュック',3,'バックバッグ',3000,10,default);
...
INSERT INTO items (item_id, category_id, item_name, color_id, manufacturer, price, stock, recommended) VALUES (nextval('items_item_id_seq'),2,'小さいトートバッグ',3,'メゾンKABAN',3000,10,true);
INSERT INTO items (item_id, category_id, item_name, color_id, manufacturer, price, stock, recommended) VALUES (nextval('items_item_id_seq'),2,'小さいショルダーバッグ',3,'メゾンKABAN',3000,10,true);
INSERT INTO items (item_id, category_id, item_name, color_id, manufacturer, price, stock, recommended) VALUES (nextval('items_item_id_seq'),2,'ピンキー小さいバッグ',3,'最高KABAN',3000,10,true);
INSERT INTO items (item_id, category_id, item_name, color_id, manufacturer, price, stock, recommended) VALUES (nextval('items_item_id_seq'),2,'小さくて小さいバッグ',3,'KABANバッグ',3000,10,true);
INSERT INTO items (item_id, category_id, item_name, color_id, manufacturer, price, stock, recommended) VALUES (nextval('items_item_id_seq'),2,'大きいより小さいバッグ',3,'KABANバッグ',3000,10,default);
INSERT INTO items (item_id, category_id, item_name, color_id, manufacturer, price, stock, recommended) VALUES (nextval('items_item_id_seq'),2,'めちゃでかバック',6,'KABANバッグ',3000,10,default);
INSERT INTO items (item_id, category_id, item_name, color_id, manufacturer, price, stock, recommended) VALUES (nextval('items_item_id_seq'),2,'バグバック',7,'KABANバッグ',3000,10,default);
